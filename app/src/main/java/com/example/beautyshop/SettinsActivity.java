...
public class SettinsActivity extends AppCompatActivity
{
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText passwordEditText, final EditText fullNameEditText, final EditText userPhoneEditText, final EditText addressEditText)
    {
